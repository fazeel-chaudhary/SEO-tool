...
export const INITIAL_COMPETITORS: CompetitorMetric[] = [
  {
    ...
    category: 'Dentist',
    secondaryCategories: ['Cosmetic Dentist', 'Teeth Whitening Service', 'Dental Clinic'],
    websiteUrl: 'https://austincentraldentistry.com',
    mapsUrl: 'https://maps.google.com/?cid=1029384756',
    placeId: 'ChIJz1xP38W1RIYRh84n9X-321',
    cid: '1029384756',
    phone: '(512) 555-0192',
    ...
    aiValidated: true,
    aiValidationNotes: 'Direct geographic and category competitor in Downtown Austin.',
    locationId: 'loc-1',
    createdAt: new Date().toISOString(),
  },
  {
    ...
    category: 'Dentist',
    secondaryCategories: ['Emergency Dental Service', 'Pediatric Dentist'],
    websiteUrl: 'https://westlakehillsdentistry.com',
    mapsUrl: 'https://maps.google.com/?cid=9876543210',
    placeId: 'ChIJx8yQ29X2RIYRh92m8X-888',
    cid: '9876543210',
    phone: '(512) 555-0841',
    businessHours: 'Mon-Sat: 7:30AM - 6PM',
    rating: 4.7,
    reviewCount: 198,
    ...
    isPermanentlyClosed: false,
    aiValidated: true,
    aiValidationNotes: 'High relevance competitor serving West Lake Hills & Central Austin.',
    locationId: 'loc-1',
    createdAt: new Date().toISOString(),
  },
];
...
export const INITIAL_DIY_OPPORTUNITIES: any[] = [
  {
    id: 'diy-1',
    directoryName: 'Healthgrades Medical Directory',
    domain: 'healthgrades.com',
    domainAuthority: 92,
    trustScore: 95,
    country: 'United States',
    category: 'Healthcare & Medical Specialist',
    seoValue: 'EXCEPTIONAL',
    isFree: true,
    submissionCost: 'Free Claiming',
    submissionUrl: 'https://www.healthgrades.com/update-profile',
    whyRecommended: 'Top authority healthcare directory in North America. 84% of local patients check Healthgrades before booking appointments.',
    isCompetitorGap: true,
    competitorName: 'Austin Premier Smiles',
    rankingImpactScore: 98,
    status: 'RECOMMENDED',
    locationId: 'loc-1',
  },
  {
    ...
    trustScore: 99,
    country: 'Global',
    category: 'Tier-1 Mobile Maps Network',
    seoValue: 'EXCEPTIONAL',
    isFree: true,
    submissionCost: 'Free Official API',
    submissionUrl: 'https://businessconnect.apple.com',
    whyRecommended: 'Powers Siri, Apple Maps, and iOS Spotlight searches. Essential for mobile local pack ranking on iPhones.',
    isCompetitorGap: false,
    rankingImpactScore: 96,
    status: 'IN_PROGRESS',
    proofUrl: 'https://businessconnect.apple.com/biz/10042',
    locationId: 'loc-1',
  },
  {
    id: 'diy-3',
    ...
    trustScore: 96,
    country: 'Global',
    category: 'Tier-1 Search Engine Directory',
    seoValue: 'EXCEPTIONAL',
    isFree: true,
    submissionCost: 'Free Sync',
    submissionUrl: 'https://www.bingplaces.com',
    whyRecommended: 'Direct sync available with Google Business Profile. Powers Microsoft Copilot AI and Edge browser local search results.',
    isCompetitorGap: true,
    competitorName: 'Central Texas Care Dental',
    rankingImpactScore: 94,
    status: 'RECOMMENDED',
    locationId: 'loc-1',
  },
  {
    id: 'diy-4',
    directoryName: 'Vitals Doctor & Practice Guide',
    domain: 'vitals.com',
    domainAuthority: 87,
    trustScore: 89,
    country: 'United States',
    ...
    seoValue: 'HIGH',
    isFree: true,
    submissionCost: 'Free Profile',
    submissionUrl: 'https://www.vitals.com/claim-profile',
    whyRecommended: 'High citation relevance for dental & medical categories. Competitor gap detected — 2 out of 3 main competitors are listed here.',
    isCompetitorGap: true,
    competitorName: 'Austin Smiles Dentistry',
    rankingImpactScore: 89,
    status: 'RECOMMENDED',
    locationId: 'loc-1',
  },
  {
    ...
    trustScore: 88,
    country: 'United States',
    category: 'General Business & Commerce',
    seoValue: 'HIGH',
    isFree: false,
    submissionCost: '$15 / Year',
    submissionUrl: 'https://www.chamberofcommerce.com/add-business',
    whyRecommended: 'Hyper-local trust signal boosting local Google Maps proximity authority for Central Austin location.',
    isCompetitorGap: false,
    rankingImpactScore: 85,
    status: 'COMPLETED',
    proofUrl: 'https://chamberofcommerce.com/co/austin/downtowndental',
    completedAt: '2026-07-20T14:30:00Z',
    locationId: 'loc-1',
  },
  {
    id: 'diy-6',
    directoryName: 'YellowPages Business Index',
    domain: 'yellowpages.com',
    domainAuthority: 89,
    trustScore: 91,
    country: 'United States',
    ...
    submissionUrl: 'https://www.yellowpages.com/claim-business',
    whyRecommended: 'Establishes strong foundational NAP backing for Google Local Algorithm consistency audits.',
    isCompetitorGap: false,
    rankingImpactScore: 88,
    status: 'COMPLETED',
    proofUrl: 'https://yellowpages.com/austin-tx/mip/downtown-dental',
    completedAt: '2026-07-15T10:00:00Z',
    locationId: 'loc-1',
  },
];

export const INITIAL_DFY_ORDERS: any[] = [
  {
    id: 'dfy-order-101',
    locationId: 'loc-1',
    packageCount: 50,
    ...
    orderedAt: '2026-07-24T11:20:00Z',
    items: [
      {
        id: 'dfy-item-1',
        directoryName: 'MapQuest Local Business Network',
        domain: 'mapquest.com',
        domainAuthority: 91,
        liveUrl: 'https://www.mapquest.com/us/texas/downtown-dental-austin',
        status: 'APPROVED',
        proofScreenshotUrl: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=400&q=80',
        submittedAt: '2026-07-24T12:00:00Z',
        approvedAt: '2026-07-25T09:15:00Z',
      },
      {
        id: 'dfy-item-2',
        directoryName: 'Superpages Local Business Guide',
        domain: 'superpages.com',
        domainAuthority: 86,
        liveUrl: 'https://www.superpages.com/austin-tx/bpp/downtown-dental',
        status: 'APPROVED',
        proofScreenshotUrl: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=400&q=80',
        submittedAt: '2026-07-24T12:30:00Z',
        approvedAt: '2026-07-25T11:40:00Z',
      },
      {
        id: 'dfy-item-3',
        directoryName: 'DexKnows Business Network',
        domain: 'dexknows.com',
        domainAuthority: 82,
        liveUrl: 'https://www.dexknows.com/austin-tx/bp/downtown-dental',
        status: 'SUBMITTED',
        submittedAt: '2026-07-24T14:10:00Z',
      },
      {
        id: 'dfy-item-4',
        directoryName: 'EZlocal Verified Places',
        domain: 'ezlocal.com',
        domainAuthority: 78,
        status: 'IN_PROGRESS',
      ...
      {
        id: 'dfy-item-5',
        directoryName: 'Local.com Regional Index',
        domain: 'local.com',
        domainAuthority: 76,
        status: 'PENDING',
      },
      {
        id: 'dfy-item-6',
        directoryName: 'CitySearch Local Index',
        domain: 'citysearch.com',
        domainAuthority: 85,
        status: 'REJECTED',
        rejectionReason: 'Category mismatch auto-flagged by directory moderator. Resubmission scheduled.',
