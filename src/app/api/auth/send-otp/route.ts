...
export async function POST(request: Request) {
  try {
    ...
    if (!resendApiKey) {
      ...
      return NextResponse.json({
        success: true,
        message: 'No SMTP key found. OTP code simulated in developer log/console.',
        isSimulated: true,
      });
    }
      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: sans-serif; padding: 20px; color: #1e293b;">
            ...
            <p>Please enter the following 6-digit verification code to activate your 14-day free trial:</p>
    ...
    if (res.ok) {
      ...
      return NextResponse.json(
        { success: false, error: 'Failed to deliver verification mail. Falling back to code.' },
        { status: 500 }
      );
    }
  } catch (error: any) {
